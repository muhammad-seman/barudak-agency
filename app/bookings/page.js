...
function PaymentBadge({ status, nominalDibayar }) {
  const map = {
    paid: [
      "paid",
      <>
        <LuCircleCheck size={10} /> Lunas
      </>,
    ],
    partial: [
      "partial",
      <>
        <LuCircleDot size={10} /> Sebagian ({formatRupiah(nominalDibayar)})
      </>,
    ],
    unpaid: [
      "unpaid",
      <>
        <LuCircleX size={10} /> Belum Bayar
      </>,
    ],
  };
...
export default function BookingsPage() {
  ...
  const startDownload = (id) => {
    ...
    setTimeout(() => setDownloadingId(id), 10);
    // Auto-clear iframe after 10s to be safe
  ...
  return (
    <div className="layout">
      ...
      <div className="main">
        <div className="topbar">
          <div>
            ...
            <div className="topbar-sub">
              Seluruh riwayat event dan tagihan klien
            </div>
          </div>
        ...
        <div className="page-content">
          ...
          >
            ...
            <div
              className="badge badge-secondary mobile-full-width"
              style={{
                marginLeft: "auto",
                padding: "10px 16px",
                fontSize: 13,
          ...
          <div className="flex gap-2 mb-4" style={{ flexWrap: "wrap" }}>
            <span
              ...
              style={{ fontSize: 13, alignSelf: "center", marginRight: 4 }}
            >
              Filter Layanan:
            </span>
            {CATEGORIES.map((c) => {
            ...
            {loading ? (
              ...
              <div className="table-wrap">
                <table>
                  <thead>
                    <tr>
                      <th className="hidden-mobile" style={{ width: "40px" }}>
                        #
                      </th>
                      <th style={{ minWidth: "160px" }}>Pasangan</th>
                      <th className="hidden-mobile" style={{ width: "100px" }}>
                        WhatsApp
                      </th>
      ...
      {/* Hidden iframe for background PDF generation */}
      {downloadingId && (
        <iframe
          src={`/bookings/print/${downloadingId}`}
          style={{
            position: "fixed",
            left: "-9999px",
            top: "-9999px",
            width: "850px", // Give it a proper width
            height: "1200px",
            border: "none",
            pointerEvents: "none",
            zIndex: -1,
